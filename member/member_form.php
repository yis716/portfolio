...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#id").keyup(function() {     // id입력 상자에 id값 입력시
            var id = $('#id').val();    //a(aa, ...뭐든)를 치는 순간

                $.ajax({
                    type: "POST",
                    url: "check_id.php",
                    data: "id="+ id,        // check_id.php?id= +id 넘어가서 체크
                    cache: false,
                    success: function(data)
                    {
                        //data => echo "문자열" 이 저장된 걸 가져온다
                        //console.log(data);
                        $("#loadtext").html(data);
                    }
                });
    ...
    <article id="content">
        ...
        <div class="joinform_wrap">
            <form  name="member_form" method="post" action="insert.php">
                ...
                <div class="join_txt">
                    <span>영문 또는 숫자로 4자~12자로 입력해 주세요.</span>
                </div>
                <dl>
                ...
                <div class="join_txt">
                    <span>영문, 숫자, 특수문자 혼합하여 8자~15자로 입력해주세요.</span>
                </div>
                <dl>
                ...
                <div class="join_txt">
                    <span>한글기준 2자~8자, 영문기준 4자~16자로 입력해주세요.</span>
                </div>
                <dl class="hp">
                    <dt>휴대폰</dt>
                    <dd>
