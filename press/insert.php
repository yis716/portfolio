...
<?
	...
	*/
	...
	else     //새글쓰기이면
	{
		...
		$sql = "insert into $table (id, name, nick, subject, category_1, content, regist_day, hit, is_html, ";
		$sql .= " file_name_0, file_name_1, file_name_2, file_copied_0,  file_copied_1, file_copied_2) ";
		$sql .= "values('$userid', '$username', '$usernick', '$subject','$category_1', '$content', '$regist_day', 0, '$is_html', ";
