            ...
            <form  name="find" method="post" action="find2.php">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" title="이름" name="name" class="find_name" required placeholder="이름을 입력하세요">
                    </li>
                    <li>
                        <label for="id" class="hidden">아이디</label>
                        <input type="text" title="아이디" name="id" class="find_id" required placeholder="아이디를 입력하세요">
                    </li>
                    <li class="hp">
